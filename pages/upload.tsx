...
const Upload = () => {
    ...
    return (
        <div className='flex w-full h-full absoulute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
            <div className='bg-white rounded-lg xl:h-[80vh] w-[80%] flex gap-6 flex-wrap justify-between items-center p-14 pt-6'>
                <div>
                    <div>
                        <p className='text-2xl font-bold'>Upload Video</p>
                        <p className='text-md text-gray-400'>Post a video to universe!</p>
                    </div>
                                    ...
                                    {videoAsset ? (
                                        ...
                                        (
                                            <label className='cursor-pointer'>
                                                ...
                                                <input type="file"
                                                    name="upload-video" className='w-0 h-0' onChange={uploadVideo}>
                                                </input>
                                            </label>
                                        )}
                                </div>
