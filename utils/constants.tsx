...
import { FaPaw, FaMedal, FaGamepad, FaSpaceShuttle } from 'react-icons/fa';
...
export const footerList2 = [ 'TrekTok for Good','Advertise','Developers','Transparency','TrekTok Rewards' ]
